            ...
            <div className="relative z-10 w-full flex flex-col items-center">
                <div className="text-center mb-10">
                    <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tight">
                        Welcome Back to <span className="bg-gradient-to-r from-[#00FFC2] to-sky-400 bg-clip-text text-transparent">SAHA AI</span>
                    </h1>
                            ...
                            <form onSubmit={handleForgotPassword}>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="pl-12 w-full bg-gray-800 border border-gray-700 rounded-lg py-3 px-4 text-gray-200 focus:ring-2 focus:ring-[#00FFC2]/50 focus:border-[#00FFC2] outline-none transition duration-300"
                                    />
                                </div>
                                <button
                                    type="submit"
                                    disabled={resetLoading}
                                    className="w-full mt-6 py-3 px-4 rounded-lg text-black bg-[#00FFC2] font-bold text-base hover:bg-teal-300 transition-all duration-300 shadow-lg shadow-teal-400/30 disabled:bg-gray-600 disabled:cursor-not-allowed flex items-center justify-center"
                                >
                                    {resetLoading ? (
                                        <>
                                            <svg className="animate-spin -ml-1 mr-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
